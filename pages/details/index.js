    ...
    <>
      <CreateLayout title="Details">
        <div className="px-6 lg:px-1 mt-8 poppins">
          <div className="text-[20px] py-1 font-normal  text-black ">Main event image</div>
          <div className="text-sm py-1 font-normal  text-[#858585]">This is the first image attendees will see at the top of your listing</div>
            ...
            <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 bg-[#F0F0F0]">
              <div className="text-center" >
                ...
                <div className="mt-4 flex text-sm leading-6 text-gray-600">
                  ...
                  <p className="pl-1">or drag and drop PNG, JPG</p>
                </div>
